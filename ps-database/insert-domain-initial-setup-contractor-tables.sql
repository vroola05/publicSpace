...
INSERT INTO public.page_overview (id, page_id, name, icon, toggle, route, size, priority, personal, sort) VALUES (nextval('public.seq_page_overview_id'), currval('public.seq_page_id'), 'Nieuwe opdracht', 'fiber_new', true, 'details/${calllist.id}', 50, true, false, 0);
...
INSERT INTO public.page_button (id, page_id, page_overview_id, location, button_type_id, name, route, action_type_id, sort) VALUES (nextval('public.seq_page_button_id'), NULL, currval('public.seq_page_overview_id'), 'left', get_page_button_type('containedPrimary'), 'Opdracht informatie', '/details/${calllist.id}', NULL, 0);
INSERT INTO public.page_button (id, page_id, page_overview_id, location, button_type_id, name, route, action_type_id, sort) VALUES (nextval('public.seq_page_button_id'), NULL, currval('public.seq_page_overview_id'), 'right', get_page_button_type('containedPrimary'), 'Opdracht toewijzen', '/assign/${calllist.id}', NULL, 0);
...
-- TAB: In behandeling
INSERT INTO public.page_overview (id, page_id, name, icon, toggle, route, size, priority, personal, sort) VALUES (nextval('public.seq_page_overview_id'), currval('public.seq_page_id'), 'In behandeling', 'event', false, 'details/${calllist.id}', 50, true, true, 1);
...
INSERT INTO public.page_button (id, page_id, page_overview_id, location, button_type_id, name, route, action_type_id, sort) VALUES (nextval('public.seq_page_button_id'), NULL, currval('public.seq_page_overview_id'), 'left', get_page_button_type('containedPrimary'), 'Opdracht informatie', '/details/${calllist.id}', NULL, 0);
INSERT INTO public.page_button (id, page_id, page_overview_id, location, button_type_id, name, route, action_type_id, sort) VALUES (nextval('public.seq_page_button_id'), NULL, currval('public.seq_page_overview_id'), 'right', get_page_button_type('containedPrimary'), 'Opdracht maken', '/details/${calllist.id}/order/creation', NULL, 0);
INSERT INTO public.page_button_roles(id, page_button_id, role_id, allow) VALUES (nextval('public.seq_page_button_role_id'), currval('public.seq_page_button_id'), get_role('ROLE_USER'), true);
INSERT INTO public.page_button_roles(id, page_button_id, role_id, allow) VALUES (nextval('public.seq_page_button_role_id'), currval('public.seq_page_button_id'), get_role('ROLE_ADMIN'), true);
...
INSERT INTO public.page_overview (id, page_id, name, icon, toggle, route, size, priority, personal, sort) VALUES (nextval('public.seq_page_overview_id'), currval('public.seq_page_id'), 'Zoek een opdracht', 'search', false, 'details/${calllist.id}', 50, false, false, 2);
