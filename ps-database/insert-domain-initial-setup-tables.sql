...
INSERT INTO public.page_button (id, page_id, location, button_type_id, name, route, action_type_id, sort) VALUES (nextval('public.seq_page_button_id'), 2, 'left', 2, 'Vorige', '', 12, 0);
INSERT INTO public.page_button (id, page_id, location, button_type_id, name, route, action_type_id, sort) VALUES (nextval('public.seq_page_button_id'), 4, 'left', 2, 'Annuleren', '', 13, 0);
INSERT INTO public.page_button (id, page_id, location, button_type_id, name, route, action_type_id, sort) VALUES (nextval('public.seq_page_button_id'), 4, 'right', 1, 'Volgende', '/new/information', 14, 0);
INSERT INTO public.page_button (id, page_id, location, button_type_id, name, route, action_type_id, sort) VALUES (nextval('public.seq_page_button_id'), 5, 'right', 1, 'Controleer de melding', '/new/confirmation', 14, 0);
INSERT INTO public.page_button (id, page_id, location, button_type_id, name, route, action_type_id, sort) VALUES (nextval('public.seq_page_button_id'), 5, 'left', 2, 'Vorige', '', 12, 0);
INSERT INTO public.page_button (id, page_id, location, button_type_id, name, route, action_type_id, sort) VALUES (nextval('public.seq_page_button_id'), 6, 'left', 2, 'Annuleren', '', 13, 0);
INSERT INTO public.page_button (id, page_id, location, button_type_id, name, route, action_type_id, sort) VALUES (nextval('public.seq_page_button_id'), 6, 'left', 2, 'Vorige', '', 12, 1);
INSERT INTO public.page_button (id, page_id, location, button_type_id, name, route, action_type_id, sort) VALUES (nextval('public.seq_page_button_id'), 6, 'right', 1, 'Melding maken', '', 2, 0);
