...
INSERT INTO public.page_overview (id, page_id, name, icon, toggle, route, priority, personal, sort) VALUES (1, 1, 'Nieuwe meldingen', 'fiber_new', true, '', true, false, 0);
INSERT INTO public.page_overview (id, page_id, name, icon, toggle, route, priority, personal, sort) VALUES (2, 1, 'In behandeling', 'event', false, '', true, true, 1);
INSERT INTO public.page_overview (id, page_id, name, icon, toggle, route, priority, personal, sort) VALUES (3, 1, 'Zoek een melding', 'search', false, '', false, false, 2);
