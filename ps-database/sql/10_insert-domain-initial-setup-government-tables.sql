...
INSERT INTO public.status (id, name, domain_id) VALUES (nextval('public.seq_status_id'), 'Opdracht verstuurd naar aannemer', get_last_id('public.seq_domain_id'));
INSERT INTO public.status (id, name, domain_id) VALUES (nextval('public.seq_status_id'), 'Alle opdrachten afgesloten', get_last_id('public.seq_domain_id'));
...
INSERT INTO public.page_overview_status (id, page_overview_id, status_id) VALUES (nextval('public.seq_page_overview_status_id'), currval('public.seq_page_overview_id'), get_status_by_name(get_last_id('public.seq_domain_id'), 'Opdracht verstuurd naar aannemer'));
INSERT INTO public.page_overview_status (id, page_overview_id, status_id) VALUES (nextval('public.seq_page_overview_status_id'), currval('public.seq_page_overview_id'), get_status_by_name(get_last_id('public.seq_domain_id'), 'Alle opdrachten afgesloten'));
...
INSERT INTO public.page_button_roles(id, page_button_id, role_id, allow) VALUES (nextval('public.seq_page_button_role_id'), currval('public.seq_page_button_id'), get_role('ROLE_USER'), true);
INSERT INTO public.page_button_roles(id, page_button_id, role_id, allow) VALUES (nextval('public.seq_page_button_role_id'), currval('public.seq_page_button_id'), get_role('ROLE_ADMIN'), true);
INSERT INTO public.page_button_condition (id, page_button_id, field, operator, value) VALUES (nextval('public.seq_page_button_condition_id'), currval('public.seq_page_button_id'), 'call.status.name', 'neq', 'Afgesloten');
...
INSERT INTO public.page_button_condition (id, page_button_id, field, operator, value) VALUES (nextval('public.seq_page_button_condition_id'), currval('public.seq_page_button_id'), 'call.status.name', 'eq', 'Opdracht verstuurd naar aannemer');
INSERT INTO public.page_button_condition (id, page_button_id, field, operator, value) VALUES (nextval('public.seq_page_button_condition_id'), currval('public.seq_page_button_id'), 'call.status.name', 'eq', 'Alle opdrachten afgesloten');
...
INSERT INTO public.page_button (id, page_id, page_overview_id, location, button_type_id, name, route, action_type_id, sort) VALUES (nextval('public.seq_page_button_id'), currval('public.seq_page_id'), NULL, 'right', get_page_button_type('containedPrimary'), 'Opslaan', '', get_action_type('Nieuwe opdracht(en) aangemaakt'), 1);
...
INSERT INTO public.action (id, action_type_id, domain_id, status_id) VALUES (nextval('public.seq_action_id'), get_action_type('Alle opdrachten gesloten'), get_last_id('public.seq_domain_id'), get_status_by_name(get_last_id('public.seq_domain_id'), 'Alle opdrachten afgesloten'));
...
INSERT INTO public.action (id, action_type_id, domain_id, status_id) VALUES (nextval('public.seq_action_id'), get_action_type('Nieuw opdracht(en) aangemaakt'), get_last_id('public.seq_domain_id'), get_status_by_name(get_last_id('public.seq_domain_id'), 'In behandeling'));
INSERT INTO public.action (id, action_type_id, domain_id, status_id) VALUES (nextval('public.seq_action_id'), get_action_type('Opdracht aanmaken'), get_last_id('public.seq_domain_id'), NULL);
