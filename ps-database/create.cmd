...
set PGPASSWORD=postgresPassword&& psql -h localhost -U postgres -f sql/create_database.sql
...
set PGPASSWORD=postgresPassword&& psql -h localhost -U postgres -f sql/create_tables.sql

set PGPASSWORD=postgresPassword&& psql -h localhost -U postgres -f sql/create_audit.sql

set PGPASSWORD=postgresPassword&& psql -h localhost -U postgres -f sql/geo.sql

set PGPASSWORD=postgresPassword&& psql -h localhost -U postgres -f sql/create_functions.sql
...
set PGPASSWORD=postgresPassword&& psql -h localhost -U postgres -f sql/insert-domain-tables.sql -v domain_domain="'%DOMAIN_DOMAIN%'" -v domain_name="'%DOMAIN_NAME%'" -v domain_type="'%DOMAIN_TYPE%'" -v domain_group_name1="'%DOMAIN_GROUP_NAME1%'" -v domain_group_name2="'%DOMAIN_GROUP_NAME2%'" -v domain_group_name3="'%DOMAIN_GROUP_NAME3%'"
...
set PGPASSWORD=postgresPassword&& psql -h localhost -U postgres -f sql/insert-domain-initial-setup-government-tables.sql
...
set PGPASSWORD=postgresPassword&& psql -h localhost -U postgres -f sql/insert-domain-initial-setup-contractor-tables.sql

set PGPASSWORD=postgresPassword&& psql -h localhost -U postgres -f sql/insert-locations1.sql
set PGPASSWORD=postgresPassword&& psql -h localhost -U postgres -f sql/insert-locations2.sql
set PGPASSWORD=postgresPassword&& psql -h localhost -U postgres -f sql/insert-locations3.sql
set PGPASSWORD=postgresPassword&& psql -h localhost -U postgres -f sql/insert-locations4.sql
set PGPASSWORD=postgresPassword&& psql -h localhost -U postgres -f sql/insert-locations5.sql
set PGPASSWORD=postgresPassword&& psql -h localhost -U postgres -f sql/insert-locations6.sql
set PGPASSWORD=postgresPassword&& psql -h localhost -U postgres -f sql/insert-locations7.sql
set PGPASSWORD=postgresPassword&& psql -h localhost -U postgres -f sql/insert-locations8.sql
set PGPASSWORD=postgresPassword&& psql -h localhost -U postgres -f sql/insert-locations9.sql
