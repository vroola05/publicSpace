...
set USER_SALT="$(java -cp sec-class org.commonground.ps.backendapi.core.security.SecureHash --function "salt" --password "%USER_PASSWORD%" --hash-function "%HASH_FUNCTION%" --salt-length %SALT_LENGTH% --iteration-count %ITERATION_COUNT% --key-length %KEY_LENGTH%)"
set USER_PASSWORD_ENCRYPT="$(java -cp sec-class org.commonground.ps.backendapi.core.security.SecureHash --function "password" --password "%USER_PASSWORD%" --hash-function "%HASH_FUNCTION%" --salt-length %SALT_LENGTH% --salt "%USER_SALT%" --iteration-count %ITERATION_COUNT% --key-length %KEY_LENGTH%)"
...
set USER_SALT_CONTR="$(java -cp sec-class org.commonground.ps.backendapi.core.security.SecureHash --function "salt" --password "$USER_PASSWORD_CONTR" --hash-function "%HASH_FUNCTION%" --salt-length %SALT_LENGTH% --iteration-count %ITERATION_COUNT% --key-length %KEY_LENGTH%)"
set USER_PASSWORD_ENCRYPT_CONTR="$(java -cp sec-class org.commonground.ps.backendapi.core.security.SecureHash --function "password" --password "$USER_PASSWORD_CONTR" --hash-function "%HASH_FUNCTION%" --salt-length %SALT_LENGTH% --salt "$USER_SALT_CONTR" --iteration-count %ITERATION_COUNT% --key-length %KEY_LENGTH%)"
