...
@Constraint(validatedBy = { PutCategoryValidator.Validator.class })
public @interface PutCategoryValidator {
	...
	class Validator implements ConstraintValidator<PutCategoryValidator, Category> {
		@Override
