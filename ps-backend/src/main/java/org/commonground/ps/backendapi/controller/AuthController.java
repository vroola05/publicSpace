...
public class AuthController extends Controller {
  ...
  private SessionRepository sessionRepository;
	...
	public ResponseEntity<User> login(@Valid @RequestBody Login login) throws ForbiddenException {

		Optional<UserEntity> userEntityOptional = userRepository.getUserByUsername(login.getUsername());
