...
public interface ContractSpecificationItemsRepository extends JpaRepository<ContractSpecificationItemEntity, Long> {
  ...
  List<ContractSpecificationItemEntity> getContractSpecificationItems(@Param("domainIdGovernment") Long domainIdGovernment, @Param("domainIdContractor") Long domainIdContractor, Date date);
}
