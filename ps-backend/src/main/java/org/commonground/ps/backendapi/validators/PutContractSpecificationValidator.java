...
@Constraint(validatedBy = { PutContractSpecificationValidator.Validator.class })
public @interface PutContractSpecificationValidator {
	...
	class Validator implements ConstraintValidator<PutContractSpecificationValidator, ContractSpecification> {
