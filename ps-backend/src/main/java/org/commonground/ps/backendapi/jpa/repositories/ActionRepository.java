...
public interface ActionRepository extends JpaRepository<ActionEntity, Long> {
  ...
  Optional<ActionEntity> getActionByDomainIdAndActionId(@Param("domainId") Long domainId, @Param("actionId") Long actionId);

  @Query("select a from ActionEntity a where a.domain.id = :#{#domainId} and a.actionType.id = :#{#actionTypeId}")
  Optional<ActionEntity> getActionByDomainIdAndActionTypeId(@Param("domainId") Long domainId, @Param("actionTypeId") Long actionTypeId);
}
