...
public interface ContractRepository extends JpaRepository<ContractEntity, Long> {
  ...
  @Query("select c from ContractEntity c where c.domainGovernment.id = :#{#domainIdGovernment} and c.domainContractor.id = :#{#domainIdContractor}  and c.accepted = true")
  Optional<ContractEntity> getContractByAccepted(@Param("domainIdGovernment") Long domainIdGovernment, @Param("domainIdContractor") Long domainIdContractor);
