{
  ...
  "endpoints": {
    ...
    "deleteOrder": { "endpoint": "/order/${order.id}", "roles": ["ROLE_ADMIN"] },
    ...
    "findContractorsByName": {"endpoint": "/company/${environment.company.id}/domain/${environment.domain.id}/contractor/domain", "roles": ["ROLE_ADMIN", "ROLE_USER"]},
    ...
    "postOrderNote": { "endpoint": "/order/${order.id}/note", "roles": ["ROLE_ADMIN", "ROLE_USER"] },
